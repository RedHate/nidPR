...
enum PspDebugKbSettings {
  ...
  PSP_DEBUG_KB_CHAR_COLOUR = WHITE,
  PSP_DEBUG_KB_BACK_COLOUR = BLACK,
  /** FG and BG colour of highlighted character */
  PSP_DEBUG_KB_CHAR_HIGHLIGHT = MAGENTA,
  PSP_DEBUG_KB_BACK_HIGHLIGHT = BLACK,
